...
<p>Authorised Signatory</p>
    ...
    <div class="col-12">
        <div com-fm="delivery-to" class="com-wrapper">
    ...
    <div class="col-12 mt-3">
        <div com-fm="logo" class="com-wrapper close disable">
            <div class="com-container">
                <div class="com-header">
                    <div class="row">
                        <div class="col-8">
    ...
    <div class="col-12 mt-3">
        <div com-fm="header" class="com-wrapper close">
            <div class="com-container">
                <div class="com-header">
                    <div class="row">
                        <div class="col-8">
                        ...
                        <div class="item-1">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    ...
                                    <input data-fm="h-1" id="h-1" value="Age" type="text"
                                        class="form-control">
                                </div>
                ...
                <div class="com-body pb-0">
                    <div class="border-bottom pb-3 row">
                        ...
                        <div class="col-12 col-lg-6">
                            <label class="form-label" for="field-name-discount">Field Name</label>
                            <input class="form-control" data-fm="field-name-discount"
                                id="field-name-discount" type="text">
                        </div>
                        <div class="col-12 col-lg-5 mt-3 mt-lg-0">
                            <label class="form-label" for="field-value-discount">value</label>
                    ...
                    <div class="border-bottom pb-3 row mt-2">
                        ...
                        <div class="col-12 col-lg-6">
                            <label class="form-label" for="field-name-cgst">Field Name</label>
                            <input class="form-control" data-fm="field-name-cgst" id="field-name-cgst"
                                type="text">
                        </div>

                        <div class="col-12 col-lg-6 mt-3 mt-lg-0">
                            <label class="form-label" for="field-value-cgst">value</label>
                            <input class="form-control" data-fm="field-value-cgst" id="field-value-cgst"
                                type="text">
                        </div>

                        <div class="col-12 mt-3">
                            <label class="form-label" for="field-name-cgstinr">Field Name</label>
                    ...
                    <div class="border-bottom pb-3 mt-3 row">
                        ...
                        <div class="col-12 col-lg-6">
                            <label class="form-label" for="field-name-sgst">Field Name</label>
                            <input class="form-control" data-fm="field-name-sgst" id="field-name-sgst"
                                type="text">
                        </div>
                        <div class="col-12 col-lg-6 mt-3 mt-lg-0">
                            <label class="form-label" for="field-value-sgst">Value</label>
                        ...
                        <div class="col-12 mt-3">
                            <label class="form-label" for="field-name-sgstinr">Field Name</label>
                        ...
                        <!-- <div class="col-12 col-lg-5 mt-3">
                            <label class="form-label" for="field-value-sgstinr">Tax</label>
                            <input class="form-control" disabled data-fm="field-value-sgstinr" id="field-value-sgstinr" type="text">
                        </div> -->
